...
public class PendulumRunner {
    ...
    public static void main (String [] args) {
    	...
    	// initializes a SimplePendulum and a RegularPendulum with a GravityConstant object.
    	GravityConstant earth =new GravityConstant(9.81); // Earth’s
    	GravityConstant Jupiter = new GravityConstant(25); // Jupiter’s
